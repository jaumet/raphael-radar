...
(function() {
  ...
  Raphael.fn.radarchart = function (cx, cy, radius, labels, max_score, score_groups, my, user_draw_options)
  {
    ...
    var global_draw_defaults = {
      text: { fill: 'red', 'max-chars': 10, 'key': true },
    }
    ...
    for (var i = 0; i < points.length; i++) {
      ...
      measures.push( this.path("M " + cx + " " + cy + " L " + x + " " + y).attr("stroke", "# ") );
    ...
    for (var i=0; i<score_groups.length; i++) {
      var default_draw_options = { points: {'fill':'orange','stroke-width':'0', 'size': 8},
